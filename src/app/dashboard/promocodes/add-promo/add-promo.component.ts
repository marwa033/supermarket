...
export class AddPromoComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.params.subscribe(params => {
      ...
      this.promoService.GetId(this.id).
      then( response => { this.result = response;
        console.log(this.result)
        this.code = this.result.code;
        this.total = this.result.totalUsage;
        this.days = this.result.daysPeriod;
        this.startDate = this.result.startDate;
        this.max = this.result.maxNumberOfUses;
        this.amount = this.result.amount;
        this.type = this.result.type;
        this.for = this.result.for;
        this.minOrder = this.result.minOrder;
        this.maxOrder = this.result.maxOrder;
        setTimeout(() => {
          this.spinner.hide();
        }, this.result);
